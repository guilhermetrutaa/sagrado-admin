  ...
  return (
    <div className='bg-gray-100 min-h-screen'>
      <div className='flex justify-center items-center pt-10'>
        <h1 className='text-[2rem] text-[#AB0000]'>BEM VINDO(A) <span className='font-semibold'>PASCOM</span></h1>
        <Image src="/logo-pascom.svg" alt="LogoPascom" width={100} height={150} />
      </div>
